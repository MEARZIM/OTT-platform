...
const Banner = () => {
  ...
  >
    ...
    <CarouselPrevious className="absolute left-2 top-1/2 -translate-y-1/2 size-10 bg-blue-200/50 border-none p-2 rounded-full text-blue-700 hover:bg-gray-800 cursor-pointer" />
    <CarouselNext className="absolute right-2 top-1/2 -translate-y-1/2 size-10 bg-blue-200/50 border-none p-2 rounded-full text-blue-700 hover:bg-gray-800 cursor-pointer" />
  </Carousel>
</div>
